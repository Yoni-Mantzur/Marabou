...
//    }
    ...
    void test_sigmoid_4()
    {
        ...
        inputQuery.setLowerBound( 8, FloatUtils::sigmoid(1.40) );
        inputQuery.setUpperBound( 8, FloatUtils::sigmoid(1.41) );
...
//        inputQuery.markOutputVariable(8, 0);
        ...
        if ( !FloatUtils::areEqual( value_x3f, value_x4b ) )
            correctSolution = false;
        ...
        if ( FloatUtils::lt( value_x0, 0.5) || FloatUtils::gt( value_x0, 1 ) ||
             ...
             FloatUtils::lt( value_x4f, FloatUtils::sigmoid(2*FloatUtils::sigmoid(0.5)) ) ||
             FloatUtils::gt( value_x4f, FloatUtils::sigmoid(2*FloatUtils::sigmoid(1)) )   ||
             FloatUtils::lt( value_x5, FloatUtils::sigmoid(1.40) ) ||
             FloatUtils::gt( value_x5, FloatUtils::sigmoid(1.41) ) )
        {
            correctSolution = false;
        }
